...
export default function OnboardingTour() {
    ...
    const compute = () => {
      ...
      setTimeout(() => {
        ...
        if (el2) {
          ...
          // fallback: spotlight center of screen
          const w = 400, h = 200;
          setTargetRect({
  ...
  // 4 rectangles that form the dimmed backdrop around the spotlight hole
  ...
  return (
    <div className="fixed inset-0 z-[100] pointer-events-none" aria-modal="true">
      {/* 4-piece backdrop: 4 rectangles forming a spotlight cut-out */}
      {targetRect && (
        <>
          {/* top bar */}
          <div
